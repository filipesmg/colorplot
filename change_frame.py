...
################################################################################
def global_to_local(values_global,deltas):
  ...
  for line_x,line_y,line_z in zip(values_global[0],values_global[1],values_global[2]):
    ...
    if line_x[-2]<=1 and line_x[-1]<=1:
      ...
      print "TEM"
    # vec = ( line_x[2] , line_y[2] , line_z[2] )
    # vec = np.array(vec)
    ...
    # if(line_x[0] == 0.75) or (line_x[0] == 1.25):
    #   # print line_x[0],line_x[3],line_x[4], vec[0]*zp[0], vec[1]*zp[1], vec[2]*zp[2], longitud
    #   print line_x[0],line_x[3],line_x[4], vec[0]*zp[0], vec[1]*zp[1], vec[2]*zp[2], longitud
